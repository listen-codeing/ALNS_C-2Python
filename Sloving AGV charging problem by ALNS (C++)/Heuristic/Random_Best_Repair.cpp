...
Random_Best_Repair::Random_Best_Repair(std::string s)
    : ARepairOperator(s) {
}

Random_Best_Repair::~Random_Best_Repair() {
}

void Random_Best_Repair::repairSolution(ISolution& sol) {
    cout<<"Random_Best_Repair:"<<endl;
...
void Random_Best_Repair::recalculateCompleteSchedule(AGV_solution& agv_sol){
...
void Random_Best_Repair::processInterval(AGV_solution& agv_sol, int v) {
    auto& agv = agv_sol.agvs[v];
    //��͵���
...
//                    }
                    ...
                    if (min_charge < 0) min_charge =0.2*max_charge;
...
int Random_Best_Repair::selectOptimalChargingStation(AGV_solution& agv_sol, int agv_id, int pos, double current_soc) {
    // if (agv_sol.pm->C == 1) {
    //     return 0;
    // }
...
void Random_Best_Repair::addChargingOperation(AGV_solution& agv_sol,int agv_id, int pos, int station_id) {
    auto& agv = agv_sol.agvs[agv_id];
