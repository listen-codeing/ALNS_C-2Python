...
#ifndef ADAPTIVE_TIME_REPAIR_H
#define ADAPTIVE_TIME_REPAIR_H
...
class Adaptive_Time_Repair : public ARepairOperator {
public:

    // 构造和析构函数
    explicit Adaptive_Time_Repair(std::string s);
    virtual ~Adaptive_Time_Repair();
...
private:
    ...
    bool getPossibleChargeWithSoc(AGV_solution& agv_sol,double soc_task);
