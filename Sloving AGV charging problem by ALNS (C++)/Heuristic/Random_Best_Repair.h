...
#ifndef RANDOM_BEST_REPAIR_H
#define RANDOM_BEST_REPAIR_H
...
class Random_Best_Repair : public ARepairOperator {
public:


    // 构造和析构函数
    explicit Random_Best_Repair(std::string s);
    virtual ~Random_Best_Repair();
