...
#ifndef ADAPTIVE_RANDOM_REPAIR_H
#define ADAPTIVE_RANDOM_REPAIR_H
...
class Adaptive_Random_Repair : public ARepairOperator {
public:


    // 构造和析构函数
    explicit Adaptive_Random_Repair(std::string s);
    virtual ~Adaptive_Random_Repair();
...
#endif //ADAPTIVE_RANDOM_REPAIR_H
