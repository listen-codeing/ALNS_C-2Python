...
#ifndef GREEDY_BEST_REPAIR_H
#define GREEDY_BEST_REPAIR_H
...
class Greedy_Best_Repair : public ARepairOperator {
public:


    // 构造和析构函数
    explicit Greedy_Best_Repair(std::string s);
    virtual ~Greedy_Best_Repair();
